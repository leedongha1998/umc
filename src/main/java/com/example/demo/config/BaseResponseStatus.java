...
public enum BaseResponseStatus {
    ...
    FAILED_TO_MEMBER(false,HttpStatus.NOT_FOUND.value(),"없는 회원입니다."),
    FAILED_TO_PHONE(false,HttpStatus.NOT_FOUND.value(),"잘못된 전화번호 형식입니다."),

    FAILED_TO_BADGE(false,HttpStatus.NOT_FOUND.value(),"없는 벳지입니다."),

    FAILED_TO_PRODUCT(false,HttpStatus.NOT_FOUND.value(), "상품이 없습니다."),
